...
export const KapList: React.FC = () => {
  ...
  const fetchData = () => {
    setLoading(true);
    api.getKapNotifications()
      .then(setNotifications)
      .catch((err) => setError('Veri çekilemedi.'))
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-gray-500">Henüz kayıtlı bildirim yok. Yukarıdan senkronize edin.</div>
        ) : (
