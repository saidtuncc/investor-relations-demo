...
app = FastAPI(title="TSGYO Investor Relations Demo API")
    ...
    demo_notifs = [
        {
            ...
            "kap_id": "1508439",
            "type": "Özel Durum",
            "title": "TSKB GYO - Özel Durum Açıklaması (Genel Bilgilendirme)",
        ...
        },
        {
            ...
            "kap_id": "1495001",
            "type": "Finansal Rapor",
            "title": "TSKB GYO - 2024/06 Ara Dönem Finansal Rapor",
        ...
        },
        {
            ...
            "title": "TSKB GYO - 2023 Yılı Faaliyet Raporu",
...
def ask_assistant(payload: AssistantQuestion) -> AssistantResponse:
    q = (payload.question or "").lower().strip()
    ...
    if ("kaç şehir" in q) or ("kaç il" in q) or ("şehir sayısı" in q):
        ...
        if count:
            answer = f"Portföy şu anda {count} farklı şehirde gayrimenkul içermektedir."
        else:
